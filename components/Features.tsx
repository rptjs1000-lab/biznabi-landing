...
const features = [
  {
    title: '온라인 예약 위젯',
    desc: '링크 하나로 고객이 24시간 예약 가능. 카카오톡, 인스타 등 어디서든 공유하세요.',
    icon: (
  ...
  {
    title: '매장 관리 대시보드',
    desc: '예약, 고객, 방문 현황을 한눈에 파악. 데이터 기반으로 매장을 운영하세요.',
    icon: (
      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  {
    title: '알림톡 자동 발송',
    desc: '예약 확인, 전날 리마인드, 방문 후 감사 메시지까지 카카오 알림톡으로 자동 전송.',
    icon: (
      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  {
    title: '맞춤 홈페이지',
    desc: '업종별로 최적화된 전문 홈페이지. 모바일 반응형, SEO 최적화 기본 포함.',
    icon: (
      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  {
    title: '고객 CRM · 재방문 알림',
    desc: '방문 이력·메모·태그를 자동 관리하고, 재방문 주기가 오면 알림톡으로 자동 안내합니다.',
    icon: (
      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
  ...
  {
    title: '리뷰 · 포인트 · 쿠폰',
    desc: '후기 자동 수집, 포인트·적립금 관리, 쿠폰 발행까지 단골 관리에 필요한 모든 도구를 한 번에.',
    icon: (
      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
