    ...
    <section id="pain-point" className="py-20 md:py-28 bg-navy">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-6">
          {/* Card 1 — 문의 놓침 */}
          <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-7 fade-up">
            <div className="w-14 h-14 rounded-xl bg-red-500/15 flex items-center justify-center mb-5">
              <svg className="w-7 h-7 text-red-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
              </svg>
            </div>
            <h3 className="text-lg font-bold text-white mb-3 break-keep">납기 끝나면 연락이 끊겨요</h3>
            <p className="text-white/55 text-sm break-keep">
          ...
          <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-7 fade-up">
            ...
            <h3 className="text-lg font-bold text-white mb-3 break-keep">프리랜서는 갑자기 끊겨요</h3>
            <p className="text-white/55 text-sm break-keep">
          ...
          {/* Card 3 — 견적서 번거로움 */}
          <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-7 fade-up">
            <div className="w-14 h-14 rounded-xl bg-sky-500/15 flex items-center justify-center mb-5">
            ...
            <h3 className="text-lg font-bold text-white mb-3 break-keep">에이전시는 견적부터 부담</h3>
            <p className="text-white/55 text-sm break-keep">
          ...
          <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-7 fade-up">
            ...
            <h3 className="text-lg font-bold text-white mb-3 break-keep">자동화는 막막하기만 해요</h3>
            <p className="text-white/55 text-sm break-keep">
