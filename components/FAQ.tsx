...
const faqs = [
  {
    ...
    answer: '업종과 요구사항에 따라 다르지만, 홈페이지 제작은 평균 7~10 영업일 정도 소요됩니다. 예약 자동화만 도입하시는 경우 3~5 영업일이면 세팅이 완료됩니다.',
  },
  {
  ...
  },
  {
    ...
    answer: '최소 계약 기간은 없습니다. 월 단위로 이용하시며 언제든 해지 가능합니다. 부담 없이 시작해보세요.',
  },
]
